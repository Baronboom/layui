...
<body>
	...
	<script type="text/html" id="barDemo">
		...
		<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="deal">合同查看</a>
	</script>
		<!--自增索引 -->
	...
	<script>
		layui.use('table', function() {
			...
			table.on('tool(test)', function(obj) {
				var data = obj.data;
				if (obj.event === 'deal') { ///lay-event 属性
					//myconfirm("确认对其回访？", function() { // 删除
						...
						openFrame('../Order/endorderdetails.jsp?id=' + data.id); // 分配自己
					//});
				} else {
